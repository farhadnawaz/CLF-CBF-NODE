...
def main():
    ...
    data_file = curr_path + '/config/Data_Trajs/trajectory_data_scooping_shifted.npy'
    ...
    data_file_orig = curr_path + '/config/Data_Trajs/trajectory_data_scooping_shifted_orig.npy'
    ...
    model_file_name = curr_path + '/config/scooping_shifted.eqx'
